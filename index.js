import { eventSource, getContext, extension_settings, loadExtensionSettings, saveSettingsDebounced } from "../../../../script.js";
...
// 加载扩展
async function loadContentBlocker() {
    // 初始化设置
    initSettings();
    ...
    console.log('Content Blocker 扩展已加载');
}
